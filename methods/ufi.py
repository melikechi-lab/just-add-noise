# Unbiased feature importance (UFI)
"""
- Paper: "Unbiased measurement of feature importance in tree-based methods" by Zhou and Hooker
- GitHub: https://github.com/ZhengzeZhou/unbiased-feature-importance
- This script was downloaded from the above GitHub repo (see UFI.py therein)
"""
...
def cls(self, X, y):
	...
	for index, tree in enumerate(self.estimators_):
		...
		for i in range(n_nodes):
			...
			# an empty in-bag set at a node is as unusable as an empty out-of-bag set (both leave
			# a term below undefined) -- flag the parent the same way in either case
